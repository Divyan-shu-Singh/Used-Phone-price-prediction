...
def predict(): 
    if request.method == 'POST': 
        ...
        test_set1 = np.array([[screeen_size,rear_camera_mp,front_camera_mp,internal_memory,
                                    ram,battery,weight,days_used,normalized_new_price,Device_Brand]])
                                    
        test_set2=np.array([[FourG,FiveG,year2014,year2015,year2016,year2017,year2018,year2019,year2020]])
        
        test_set1 = scaler.transform(test_set1)
        test_set=np.array([[test_set1[0][0],test_set2[0][0],test_set2[0][1],test_set1[0][1],test_set1[0][2],test_set1[0][3],test_set1[0][4],test_set1[0][5],test_set1[0][6],test_set1[0][7],test_set1[0][8],test_set1[0][9],test_set2[0][2],test_set2[0][3],test_set2[0][4],test_set2[0][5],test_set2[0][6],test_set2[0][7],test_set2[0][8] ]])
